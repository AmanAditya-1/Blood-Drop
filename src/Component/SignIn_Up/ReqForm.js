        ...
        <>
            <div className="register">
                    ...
                    <Card sx={{ width:"fit-content", padding:"15px", boxShadow:"0 -5px 5px -5px rgba(0, 0, 0, 0.2), 0 5px 5px -5px rgba(0, 0, 0, 0.2)"}}>
                        <CardContent>
                            <Box component="form" onSubmit={handleSubmit} Validate sx={{ mt: 2, width:'400px'}}>
                                ...
                                <Button type="submit" fullWidth variant="contained" sx={{ mt: 2, mb: 2, fontSize:'15px', fontWeight:'bold', backgroundColor:"#c6414c",':hover': {bgcolor: '#ff3300'} }} > 
                                    Request
                ...
                <div className="reg_info">
                    ...
                    <h3 style={{marginBottom:'0px', color:'#c6414c'}}>Requesting for Blood</h3>
                    <h1 style={{margin:'0px', fontSize:'40px'}}>We Are Dedicated To Help You</h1>
                    <p>
