                ...
                <nav>
                    ...
                    <div id="mySidenav" className='sidenav'>
                      {LoggedIn ? (
                        ...
                        <>
                          <button onClick={(e) => {window.open('/donor/form', '_self');}}>DONATE</button>
                          <button onClick={(e) => {window.open('/request/form', '_self');}}>REQUEST</button>
                          <button onClick={(e) => {window.open('/login', '_self');}}>LOGIN</button>
                          <button onClick={(e) => {window.open('/signup', '_self');}}>SIGN UP</button>
                        </>
                      )}
                    </div>
                </nav>
